function projetos(section) {
  section.innerHTML = `<header>
      <h2>Projetos</h2>
      <p>Passe o mouse em cima de qualquer projeto e seja um breve resumo dele!</P>
    </header>
    <div class="content">
      <div class="cards">
        <div class="card">
          <h3>Sistema de Gestão de Clientes</h3>
          <div class="img-wrapper">
            ...
            <div class="buttons">
              ...
              <a href="https://gabrielmisao-page404.vercel.app" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Sistema desenvolvido para apoiar uma Clinica de Psicologia com o Gerenciamento de todos os dados de cada cliente e seus pagamentos!
          </p>
          <p>Java - Spring - PostgreSQL - ReactJS - TypeScript - ReactBootstrap</p>
        </div>

        <div class="card">
          <h3>Sistema de Gestão de Turmas</h3>
          <div class="img-wrapper">
            <img
              class="project-img"
          ...
          <p>
            Sistema desenvolvido para apoiar uma Escola no Controle de turmas de cada aluno, onde é possível filtrar qual turma de cada aluno e quem pode busca-lo!
          </p>
          <p>Java - Spring - PostgreSQL - ReactJS - TypeScript - ReactBootstrap</p>
        </div>

        <div class="card">
          <h3>Portifólio Pessoal e Site Profissional</h3>
          <div class="img-wrapper">
            <img
              class="project-img"
            ...
            />
            <div class="buttons">
              <a href="https://github.com/zKaminise/Portif-lio-Principal/tree/main" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Página desenvolvida com intuido de demonstrar um pouco do meu trabalho e me apresentar para cada cliente, passando credibilidade e conhecimento profissional!</p>
          <p>HTML - CSS - JS</p>
        </div>

          <div class="card">
          <h3>Landing Page <br> DJ Ana Veludo</h3>
          <div class="img-wrapper">
            <img
              class="project-img"
            ...
            />
            <div class="buttons">
              <a href="https://youtu.be/kD2rb45nz30" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Landing Page exclusiva criada para a DJ Ana Veludo com intuido de expandir seu alcance e conseguir divulgar com profissionalismo seu trabalho!
          </p>
